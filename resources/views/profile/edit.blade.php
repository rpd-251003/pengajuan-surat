                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('profile.update') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="nomor_identifikasi" class="form-label">{{ __('Nomor Identifikasi') }}</label>
                                    <input
                                        id="nomor_identifikasi"
                                        ...
                                        <div class="mt-2">
                                            <div class="alert alert-warning py-2" role="alert">
                                                <small>
                                                    ...
                                                    <button form="send-verification" class="btn btn-link p-0 text-decoration-underline small text-warning">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            @if (session('status') === 'profile-updated')
                                <div class="alert alert-success py-1 px-3 mb-0 d-flex align-items-center" id="profile-saved">
                    ...
                    <form method="post" action="{{ route('password.update') }}">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            @if (session('status') === 'password-updated')
                                <div class="alert alert-success py-1 px-3 mb-0 d-flex align-items-center" id="password-saved">
                                    <i class="fas fa-check-circle me-2"></i>
