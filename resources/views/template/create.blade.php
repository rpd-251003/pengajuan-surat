            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Buat Template Surat Baru</h4>
                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nama_template"
                                                name="nama_template" value="{{ old('nama_template') }}" required>
                                            @error('nama_template')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-12 mb-3">
                                            <label for="orientation" class="form-label">Orientasi <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12 mb-3">
                                            <label for="paper_size" class="form-label">Ukuran Kertas <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control" id="footer_text" name="footer_text" rows="2">{{ old('footer_text') }}</textarea>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div id="availableVariables">
                                                ...
                                                <div class="variable-list">
                                                    <span class="badge bg-primary me-1 mb-1 variable-badge"
                                                        data-variable="tanggal_surat">tanggal_surat</span>
                                                    <span class="badge bg-primary me-1 mb-1 variable-badge"
                                                        data-variable="nomor_surat">nomor_surat</span>
                                                    <span class="badge bg-primary me-1 mb-1 variable-badge"
                                                        data-variable="nama_mahasiswa">nama_mahasiswa</span>
                                                    <span class="badge bg-primary me-1 mb-1 variable-badge"
                                                        data-variable="nim">nim</span>
                                                    <span class="badge bg-primary me-1 mb-1 variable-badge"
                                                        data-variable="prodi">prodi</span>
                                                    <span class="badge bg-primary me-1 mb-1 variable-badge"
                                                        data-variable="fakultas">fakultas</span>
                                                    <span class="badge bg-primary me-1 mb-1 variable-badge"
                                                        data-variable="tahun_angkatan">tahun_angkatan</span>
                                                </div>
                                                <div id="dynamicVariables"></div>
                                                <small class="text-muted d-block mt-2">Klik variabel untuk menambahkan ke
                                                    template</small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="row">
                                        <!-- HTML Editor -->
                                        <div class="col-12 mb-3">
                                            <label for="template_content" class="form-label">Konten Template <span
                                                    class="text-danger">*</span></label>
                                            <div class="editor-container">
                                                <textarea id="template_content" name="template_content" class="tinymce-editor">{{ old('template_content', '') }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-12 mb-3">
                                            <div class="card">
                                                <div class="card-header" data-bs-toggle="collapse"
                                                    data-bs-target="#cssSection" style="cursor: pointer;">
                                                ...
                                                <div id="cssSection" class="collapse">
                                                    <div class="card-body">
                                                        <textarea class="form-control" id="css_styles" name="css_styles" rows="8"
                                                            placeholder="Masukkan CSS untuk styling tambahan...">{{ old('css_styles') }}</textarea>
                                                        @error('css_styles')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
